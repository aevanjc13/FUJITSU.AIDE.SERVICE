...
Public Class ProjectSet
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function ViewProjectListofEmployee() As List(Of ProjectSet) Implements IProject.ViewProjectListofEmployee
        Try
            Dim lstProject As List(Of clsProject)
            Dim lstProjectSet As New List(Of ProjectSet)
            lstProject = cProjectFactory.GetAllProjectListofEmployee()
            If Not IsNothing(lstProject) Then
    ...
    Public Function GetProjectLists() As List(Of ProjectSet) Implements IProject.GetProjectLists
        Try
            Dim lstProject As List(Of clsProject)
            Dim lstProjectSet As New List(Of ProjectSet)

            lstProject = cProjectFactory.GetAllProjects()
